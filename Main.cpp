...
void n_locate(int n, int alpha, int sq_area, double **loc);
...
int main(){
  ...
  for (int node = 0; n_num[node]!=-1; node++){
    double loc[2][n_num[node]];  // an array to represent the location x,y
    ...
    /////////////////////////////////////////////////////////////////////////
    n_locate(n_num[node],alpha,sq_area,loc);
